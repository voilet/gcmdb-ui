...
app.model({ namespace: 'gresource', ...(require('/data/golang/src/gcmdbUi/src/pages/gPower/models/gresource.js').default) });
app.model({ namespace: 'grole', ...(require('/data/golang/src/gcmdbUi/src/pages/gPower/models/grole.js').default) });
app.model({ namespace: 'guser', ...(require('/data/golang/src/gcmdbUi/src/pages/gPower/models/guser.js').default) });
app.model({ namespace: 'user', ...(require('/data/golang/src/gcmdbUi/src/pages/gPower/models/user.js').default) });
