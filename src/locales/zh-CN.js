...
export default {
  ...
  'menu.resource.idc.provider': '带宽供应商',
  'menu.resource.idc.ipresource': 'ip资源管理',
  'menu.resource.idc.cabinet': '机柜管理',
  'menu.resource.idc.cabinet.list': '机柜列表',
  'menu.resource.idc.cabinet.add': '添加机柜',
  'menu.resource.hardware': '硬件管理',
  'menu.resource.hardware.host': '主机管理',
  'menu.resource.hardware.host.add': '添加主机',
  'menu.resource.hardware.host.list': '主机列表',
  'menu.resource.hardware.host.offline': '下线主机',
  'menu.resource.hardware.deviceplan': '套餐管理',
  'menu.resource.hardware.deviceplan.compose_plan': '组合套餐',
  'menu.resource.hardware.deviceplan.plan_cpu': 'cpu套餐',
  'menu.resource.hardware.deviceplan.plan_memory': '内存套餐',
  'menu.resource.hardware.deviceplan.plan_disk': '磁盘套餐',
  'menu.resource.hardware.deviceplan.plan_power': '电源套餐',
  'menu.resource.hardware.deviceplan.plan_adaptor': '网卡套餐',
  'menu.project': '项目管理',
  'menu.project.prolist': '项目列表',
  'menu.project.grouplist': '项目组列表',
  'menu.project.linelist': '产品线列表',
